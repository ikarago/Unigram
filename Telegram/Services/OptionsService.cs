...
namespace Telegram.Services
{
    public interface IOptionsService
    {
        ...
        /// </summary>
        /// <value>affiliate_program_commission_per_mille_max</value>
        long AffiliateProgramCommissionPerMilleMax { get; }

        /// <summary>
        /// Since TDLib 1.8.41. The minimum commission that can be used for an affiliate program
        /// </summary>
        /// <value>affiliate_program_commission_per_mille_min</value>
        long AffiliateProgramCommissionPerMilleMin { get; }
        ...
        /// </summary>
        /// <value>bot_verification_custom_description_length_max</value>
        long BotVerificationCustomDescriptionLengthMax { get; }
        ...
        /// </summary>
        /// <value>gift_sell_period</value>
        long GiftSellPeriod { get; }

        /// <summary>
        /// Since TDLib 1.8.37. The maximum length of a message added to a sent gift
        /// </summary>
        /// <value>gift_text_length_max</value>
        long GiftTextLengthMax { get; }
        ...
        /// </summary>
        /// <value>is_paid_reaction_anonymous</value>
        bool IsPaidReactionAnonymous { get; set; }
        ...
        /// </summary>
        /// <value>subscription_star_count_max</value>
        long SubscriptionStarCountMax { get; }
        ...
        /// </summary>
        /// <value>thousand_star_to_usd_rate</value>
        ...
        /// </summary>
        /// <value>usd_to_thousand_star_rate</value>
        ...
        /// </summary>
        /// <value>verification_codes_bot_chat_id</value>
        long VerificationCodesBotChatId { get; }
    ...
    public class OptionsService : IOptionsService
    {
        ...
        public void Update(string name, OptionValue value)
        {
            switch (name)
            {
                ...
                case "added_shareable_chat_folder_count_max":
                    ...
                    break;
                case "affiliate_program_commission_per_mille_max":
                    _affiliateProgramCommissionPerMilleMax = GetValue<long>(value);
                    break;
                case "affiliate_program_commission_per_mille_min":
                    _affiliateProgramCommissionPerMilleMin = GetValue<long>(value);
                    break;
                ...
                case "bot_media_preview_count_max":
                    ...
                    break;
                case "bot_verification_custom_description_length_max":
                    _botVerificationCustomDescriptionLengthMax = GetValue<long>(value);
                    break;
                ...
                case "gift_premium_from_input_field":
                    ...
                    break;
                case "gift_sell_period":
                    _giftSellPeriod = GetValue<long>(value);
                    break;
                case "gift_text_length_max":
                    _giftTextLengthMax = GetValue<long>(value);
                    break;
                ...
                case "ignore_sensitive_content_restrictions":
                    ...
                    break;
                case "is_paid_reaction_anonymous":
                    _isPaidReactionAnonymous = GetValue<bool>(value);
                    break;
                case "is_premium":
                ...
                case "story_viewers_expiration_delay":
                    ...
                    break;
                case "subscription_star_count_max":
                    _subscriptionStarCountMax = GetValue<long>(value);
                    break;
                ...
                case "venue_search_bot_username":
                    ...
                    break;
                case "verification_codes_bot_chat_id":
                    _verificationCodesBotChatId = GetValue<long>(value);
                    break;
                case "version":
        ...
        private long _affiliateProgramCommissionPerMilleMax;
        public long AffiliateProgramCommissionPerMilleMax => _affiliateProgramCommissionPerMilleMax;

        private long _affiliateProgramCommissionPerMilleMin;
        public long AffiliateProgramCommissionPerMilleMin => _affiliateProgramCommissionPerMilleMin;
        ...
        public string AnimationSearchBotUsername => _animationSearchBotUsername ?? string.Empty;

        private long _antiSpamBotUserId;
        public long AntiSpamBotUserId => _antiSpamBotUserId;

        private string _authenticationToken;
        public string AuthenticationToken => _authenticationToken ?? string.Empty;
        ...
        private long _botVerificationCustomDescriptionLengthMax;
        public long BotVerificationCustomDescriptionLengthMax => _botVerificationCustomDescriptionLengthMax;
        ...
        public string CommitHash => _commitHash ?? string.Empty;
        ...
        private long _giftSellPeriod;
        public long GiftSellPeriod => _giftSellPeriod;

        private long _giftTextLengthMax;
        public long GiftTextLengthMax => _giftTextLengthMax;
        ...
        private bool _isPaidReactionAnonymous;
        public bool IsPaidReactionAnonymous
        {
            get => _isPaidReactionAnonymous;
            set
            {
                _isPaidReactionAnonymous = value;
                _clientService.Send(new SetOption("is_paid_reaction_anonymous", new OptionValueBoolean(value)));
            }
        }
        ...
        {
            get => _languagePackDatabasePath ?? string.Empty;
            set
            {
        ...
        {
            get => _languagePackId ?? string.Empty;
            set
            {
        ...
        {
            get => _localizationTarget ?? string.Empty;
            set
            {
        ...
        public string PhotoSearchBotUsername => _photoSearchBotUsername ?? string.Empty;
        ...
        private long _subscriptionStarCountMax;
        public long SubscriptionStarCountMax => _subscriptionStarCountMax;

        private string _suggestedLanguagePackId;
        public string SuggestedLanguagePackId => _suggestedLanguagePackId ?? string.Empty;
        ...
        public string TMeUrl => _tMeUrl ?? string.Empty;
        ...
        public string VenueSearchBotUsername => _venueSearchBotUsername ?? string.Empty;

        private long _verificationCodesBotChatId;
        public long VerificationCodesBotChatId => _verificationCodesBotChatId;

        private string _version;
        public string Version => _version ?? string.Empty;

        private string _webAppAllowedProtocols;
        public string WebAppAllowedProtocols => _webAppAllowedProtocols ?? string.Empty;
        ...
        {
            public const string ActiveStoryCountMax = "active_story_count_max";
            public const string AddedShareableChatFolderCountMax = "added_shareable_chat_folder_count_max";
            public const string AffiliateProgramCommissionPerMilleMax = "affiliate_program_commission_per_mille_max";
            public const string AffiliateProgramCommissionPerMilleMin = "affiliate_program_commission_per_mille_min";
            public const string AlwaysParseMarkdown = "always_parse_markdown";
            public const string AnimationSearchBotUsername = "animation_search_bot_username";
            public const string AntiSpamBotUserId = "anti_spam_bot_user_id";
            public const string AuthenticationToken = "authentication_token";
            public const string AuthorizationDate = "authorization_date";
            public const string BasicGroupSizeMax = "basic_group_size_max";
            public const string BioLengthMax = "bio_length_max";
            public const string BotMediaPreviewCountMax = "bot_media_preview_count_max";
            public const string BotVerificationCustomDescriptionLengthMax = "bot_verification_custom_description_length_max";
            public const string BusinessChatLinkCountMax = "business_chat_link_count_max";
            public const string BusinessStartPageMessageLengthMax = "business_start_page_message_length_max";
            public const string BusinessStartPageTitleLengthMax = "business_start_page_title_length_max";
            public const string CallConnectTimeoutMs = "call_connect_timeout_ms";
            public const string CallPacketTimeoutMs = "call_packet_timeout_ms";
            public const string CanArchiveAndMuteNewChatsFromUnknownUsers = "can_archive_and_mute_new_chats_from_unknown_users";
            public const string CanGiftStars = "can_gift_stars";
            public const string CanIgnoreSensitiveContentRestrictions = "can_ignore_sensitive_content_restrictions";
            public const string CanPreloadWeather = "can_preload_weather";
            ...
            public const string ChatBoostLevelMax = "chat_boost_level_max";
            public const string ChatFolderChosenChatCountMax = "chat_folder_chosen_chat_count_max";
            public const string ChatFolderCountMax = "chat_folder_count_max";
            public const string ChatFolderInviteLinkCountMax = "chat_folder_invite_link_count_max";
            public const string ChatFolderNewChatsUpdatePeriod = "chat_folder_new_chats_update_period";
            public const string CommitHash = "commit_hash";
            public const string DisableAnimatedEmoji = "disable_animated_emoji";
            public const string DisableContactRegisteredNotifications = "disable_contact_registered_notifications";
            public const string DisableNetworkStatistics = "disable_network_statistics";
            public const string DisablePersistentNetworkStatistics = "disable_persistent_network_statistics";
            public const string DisableSentScheduledMessageNotifications = "disable_sent_scheduled_message_notifications";
            public const string DisableTimeAdjustmentProtection = "disable_time_adjustment_protection";
            public const string DisableTopChats = "disable_top_chats";
            public const string EnabledProxyId = "enabled_proxy_id";
            public const string ExpectBlocking = "expect_blocking";
            public const string FactCheckLengthMax = "fact_check_length_max";
            public const string FavoriteStickersLimit = "favorite_stickers_limit";
            public const string ForwardedMessageCountMax = "forwarded_message_count_max";
            public const string GiftPremiumFromAttachmentMenu = "gift_premium_from_attachment_menu";
            public const string GiftPremiumFromInputField = "gift_premium_from_input_field";
            public const string GiftSellPeriod = "gift_sell_period";
            public const string GiftTextLengthMax = "gift_text_length_max";
            public const string GiveawayAdditionalChatCountMax = "giveaway_additional_chat_count_max";
            public const string GiveawayBoostCountPerPremium = "giveaway_boost_count_per_premium";
            public const string GiveawayCountryCountMax = "giveaway_country_count_max";
            public const string GiveawayDurationMax = "giveaway_duration_max";
            public const string GroupAnonymousBotUserId = "group_anonymous_bot_user_id";
            public const string IgnoreBackgroundUpdates = "ignore_background_updates";
            public const string IgnoreDefaultDisableNotification = "ignore_default_disable_notification";
            public const string IgnoreFileNames = "ignore_file_names";
            public const string IgnoreInlineThumbnails = "ignore_inline_thumbnails";
            public const string IgnorePlatformRestrictions = "ignore_platform_restrictions";
            public const string IgnoreSensitiveContentRestrictions = "ignore_sensitive_content_restrictions";
            public const string IsPaidReactionAnonymous = "is_paid_reaction_anonymous";
            public const string IsPremium = "is_premium";
            public const string IsPremiumAvailable = "is_premium_available";
            public const string LanguagePackDatabasePath = "language_pack_database_path";
            public const string LanguagePackId = "language_pack_id";
            public const string LocalizationTarget = "localization_target";
            public const string MessageCaptionLengthMax = "message_caption_length_max";
            public const string MessageReplyQuoteLengthMax = "message_reply_quote_length_max";
            public const string MessageTextLengthMax = "message_text_length_max";
            public const string MessageUnloadDelay = "message_unload_delay";
            public const string MonthlySentStoryCountMax = "monthly_sent_story_count_max";
            public const string MyId = "my_id";
            public const string NotificationGroupCountMax = "notification_group_count_max";
            public const string NotificationGroupSizeMax = "notification_group_size_max";
            public const string NotificationSoundCountMax = "notification_sound_count_max";
            public const string NotificationSoundDurationMax = "notification_sound_duration_max";
            public const string NotificationSoundSizeMax = "notification_sound_size_max";
            public const string Online = "online";
            public const string PaidMediaMessageStarCountMax = "paid_media_message_star_count_max";
            public const string PaidReactionStarCountMax = "paid_reaction_star_count_max";
            public const string PhotoSearchBotUsername = "photo_search_bot_username";
            public const string PinnedArchivedChatCountMax = "pinned_archived_chat_count_max";
            public const string PinnedChatCountMax = "pinned_chat_count_max";
            public const string PinnedForumTopicCountMax = "pinned_forum_topic_count_max";
            public const string PinnedSavedMessagesTopicCountMax = "pinned_saved_messages_topic_count_max";
            public const string PinnedStoryCountMax = "pinned_story_count_max";
            public const string PreferIpv6 = "prefer_ipv6";
            public const string PremiumDownloadSpeedup = "premium_download_speedup";
            public const string PremiumGiftBoostCount = "premium_gift_boost_count";
            public const string PremiumUploadSpeedup = "premium_upload_speedup";
            public const string ProcessPinnedMessagesAsMentions = "process_pinned_messages_as_mentions";
            public const string QuickReplyShortcutCountMax = "quick_reply_shortcut_count_max";
            public const string QuickReplyShortcutMessageCountMax = "quick_reply_shortcut_message_count_max";
            public const string RepliesBotChatId = "replies_bot_chat_id";
            public const string StarWithdrawalCountMin = "star_withdrawal_count_min";
            public const string StorageMaxTimeFromLastAccess = "storage_max_time_from_last_access";
            public const string StoryCaptionLengthMax = "story_caption_length_max";
            public const string StoryLinkAreaCountMax = "story_link_area_count_max";
            public const string StoryStealthModeCooldownPeriod = "story_stealth_mode_cooldown_period";
            public const string StoryStealthModeFuturePeriod = "story_stealth_mode_future_period";
            public const string StoryStealthModePastPeriod = "story_stealth_mode_past_period";
            public const string StorySuggestedReactionAreaCountMax = "story_suggested_reaction_area_count_max";
            public const string StoryViewersExpirationDelay = "story_viewers_expiration_delay";
            public const string SubscriptionStarCountMax = "subscription_star_count_max";
            public const string SuggestedLanguagePackId = "suggested_language_pack_id";
            public const string SuggestedVideoNoteAudioBitrate = "suggested_video_note_audio_bitrate";
            public const string SuggestedVideoNoteLength = "suggested_video_note_length";
            public const string SuggestedVideoNoteVideoBitrate = "suggested_video_note_video_bitrate";
            public const string SupergroupSizeMax = "supergroup_size_max";
            public const string TMeUrl = "t_me_url";
            public const string TelegramServiceNotificationsChatId = "telegram_service_notifications_chat_id";
            public const string TestMode = "test_mode";
            public const string ThousandStarToUsdRate = "thousand_star_to_usd_rate";
            public const string UnixTime = "unix_time";
            public const string UsdToThousandStarRate = "usd_to_thousand_star_rate";
            public const string UsePfs = "use_pfs";
            public const string UseQuickAck = "use_quick_ack";
            public const string UseStorageOptimizer = "use_storage_optimizer";
            public const string UtcTimeOffset = "utc_time_offset";
            public const string VenueSearchBotUsername = "venue_search_bot_username";
            public const string VerificationCodesBotChatId = "verification_codes_bot_chat_id";
            public const string Version = "version";
            public const string WebAppAllowedProtocols = "web_app_allowed_protocols";
            public const string WeeklySentStoryCountMax = "weekly_sent_story_count_max";
            public const string SystemProxy = "x_system_proxy";
        }
    }
}
