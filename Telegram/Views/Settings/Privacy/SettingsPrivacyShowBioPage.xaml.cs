...
{
    public sealed partial class SettingsPrivacyShowBioPage : HostedPage
    {
        public SettingsPrivacyShowBioViewModel ViewModel => DataContext as SettingsPrivacyShowBioViewModel;

        public SettingsPrivacyShowBioPage()
        {
            InitializeComponent();
            Title = Strings.PrivacyBio;
        }
